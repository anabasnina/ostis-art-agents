...
cp -Rfv $base_path/components/opinion_adding/static/* $sc_web_static_path

stage "Install component"

append_js $sc_web_path/templates/components.html components/js/opinion_adding/opinion_adding.js
