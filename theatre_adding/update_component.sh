...
cp -Rfv $base_path/components/theatre_adding/static/* $sc_web_static_path

stage "Install component"

append_js $sc_web_path/templates/components.html components/js/theatre_adding/theatre_adding.js
